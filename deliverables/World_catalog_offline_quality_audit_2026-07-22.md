...
- Канонические карточки: **105 666**.
- Строки до каноникализации: 105 667.
- Активные предложения: 3 044.
- Дубли `canonical_key`: 0.
- Карточки с семейством, нормализованным названием, source-link и SHA-256 первичного источника: 105 666 / 105 666 / 105 666 / 105 666.
- С прямым URL первичного источника: 105 075; без производителя: 85.
- С явно помеченным fallback вместо самостоятельного бренда: 36 261.

Число 105 666 подтверждает размер текущего seed. Оно не доказывает, что все мировые продукты уже собраны.

## Покрытие профессиональными полями

| Код | Семейство | Карточки | Селектор/класс | Техническая база | Оба признака | Текущий gate |
|---|---|---:|---:|---:|---:|---|
| M | Моторные масла | 47 556 | 42 760 (89.92%) | 25 486 (53.59%) | 24 513 (51.55%) | 22 122 проблем |
...
- Quality issues: high — 311, medium — 68 491, low — 15.
...
SHA-256 проверенной сжатой SQLite: `b8f159a75c22e1a341b9bddf2653e256598e506b491a0277489f733e895e4a5b`.
