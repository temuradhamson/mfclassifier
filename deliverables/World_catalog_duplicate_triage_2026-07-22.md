...
- Канонические карточки после доказанных merge: **105 674**.
- Оставшиеся review-пары: 2 569; затронуто 1 286 карточек.
...
- Доказательно переведено в `keep_separate` по конфликтующим профессиональным полям — пар: 699.
...
| Статус | Пар | Действие |
|---|---:|---|
| `compatible_partial_specification_review` | 1 195 | Получить недостающий TDS/PDS или официальный cross-reference |
...
SHA-256 проверенной SQLite.xz: `db1c71d831d3a1c1358ed6c5a434ec2ca2ac77e7d896b1c355cf7736c8dc84e0`.
