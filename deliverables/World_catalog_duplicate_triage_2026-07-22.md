...
- Канонические карточки после доказанных merge: **105 906**.
- Оставшиеся review-пары: 6 493; затронуто 1 525 карточек.
...
- Повторных строк решений для тех же пар удалено: 4 526; все причины объединены в единственной строке пары.

## Классы оставшейся очереди

| Статус | Пар | Действие |
|---|---:|---|
| `compatible_partial_specification_review` | 2 424 | Получить недостающий TDS/PDS или официальный cross-reference |
| `complete_exact_signature_candidate` | 1 720 | Приоритетная ручная/кодовая сверка |
| `insufficient_comparable_evidence` | 2 349 | Не объединять по названию |
...
SHA-256 проверенной SQLite.xz: `b65721bd479cde097fc41a448a5ac2ba7e9200949728274dda3127b4281ecb95`.
