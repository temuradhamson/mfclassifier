...
- Канонические карточки после доказанных merge: **105 666**.
- Оставшиеся review-пары: 2 566; затронуто 1 285 карточек.
...
| Статус | Пар | Действие |
|---|---:|---|
| `compatible_partial_specification_review` | 1 192 | Получить недостающий TDS/PDS или официальный cross-reference |
| `complete_exact_signature_candidate` | 469 | Приоритетная ручная/кодовая сверка |
...
SHA-256 проверенной SQLite.xz: `b8f159a75c22e1a341b9bddf2653e256598e506b491a0277489f733e895e4a5b`.
