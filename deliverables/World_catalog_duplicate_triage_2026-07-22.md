...
- Оставшиеся review-пары: 7 237; затронуто 1 568 карточек.
...
- Доказательно переведено в `keep_separate` по конфликтующим профессиональным полям — пар: 691.
- Повторных строк решений для тех же пар удалено: 5 168; все причины объединены в единственной строке пары.

## Классы оставшейся очереди

| Статус | Пар | Действие |
|---|---:|---|
| `compatible_partial_specification_review` | 2 543 | Получить недостающий TDS/PDS или официальный cross-reference |
| `complete_exact_signature_candidate` | 1 840 | Приоритетная ручная/кодовая сверка |
| `insufficient_comparable_evidence` | 2 854 | Не объединять по названию |
...
SHA-256 проверенной SQLite.xz: `c3b23c9af2ea1681d4550cf841a876dd5a33998982a8e179e5fde28053ebb177`.
