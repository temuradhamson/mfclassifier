...
SOURCES = [
    ...
    ("FUCHS", "Switzerland", "Official embedded product finder", "https://www.fuchs.com/ch/en/products/service-links/product-finder/", 1464, "normalized product-grade rows observed", "Catalog nearly mirrors Germany but local taxonomy produces 234 fallback classifications; deferred until explicit cross-market taxonomy reconciliation", "reviewed_taxonomy_reconciliation_required"),
