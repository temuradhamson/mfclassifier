...
Отдельный provenance-aware слой содержит 97 924 канонические продуктовые строки
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 112 источников
  и статусы допуска;
