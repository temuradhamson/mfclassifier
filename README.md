...
Отдельный provenance-aware слой содержит 92 464 канонические продуктовые строки
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 109 источников
  и статусы допуска;
