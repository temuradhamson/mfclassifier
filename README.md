...
Отдельный provenance-aware слой содержит 98 064 канонические продуктовые строки
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 120 источников
  и статусы допуска;
