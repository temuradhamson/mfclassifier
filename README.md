...
Отдельный provenance-aware слой содержит 101 981 каноническую продуктовую строку
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 153 источников
  и статусы допуска;
