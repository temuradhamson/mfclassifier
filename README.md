...
Отдельный provenance-aware слой содержит 92 461 каноническую продуктовую строку
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 103 источников
  и статусы допуска;
