...
Отдельный provenance-aware слой содержит 98 152 канонические продуктовые строки
...
Mercedes-Benz Trucks DTFR, Mercedes-Benz BeVo, официальные каталоги Volvo и Mack
Genuine, Scania Genuine Engine Oils, Brava Lubricants, государственной Ceylon
...
Открытая государственная база US EPA ChemExpo/CPDat 4.1 добавляет ещё 5 714
нормализованных продуктовых identity. В профильных и смежных PUC-категориях
проверены 10 019 товарных вхождений: 7 217 сохранены, 2 802 явных топлива,
очистителя, покрытия и иных нецелевых товаров исключены, а 1 503 варианта
фасовки и повторных названий объединены внутри источника. Из полученных identity
268 сопоставлены с уже имеющимися строками и 5 446 создали новые канонические
позиции. Для каждого продукта сохранены исходные ChemExpo ID и прямые ссылки;
...
- `data/epa-chemexpo-lubricants.jsonl` — 5 714 нормализованных product identity
  из открытой ChemExpo/CPDat 4.1 с 7 217 исходными Product ID, PUC-категориями,
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 127 источников
  и статусы допуска;
