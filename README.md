...
Отдельный provenance-aware слой содержит 98 137 канонических продуктовых строк
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 126 источников
  и статусы допуска;
