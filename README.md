...
- `data/samr-china-2023-nonconforming-fluids.jsonl` и
  `data/samr-china-2025-nonconforming-fluids.jsonl` — 151 историческое событие
  национального контроля SAMR, сведённое к 150 карточкам: один и тот же продукт
  связывается между 2023 и 2025 годами; 13 контрафактных/подозреваемых партий
  остаются только в аудите и не раздувают каталог;
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 147 источников
  и статусы допуска;
