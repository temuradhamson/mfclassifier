...
Отдельный provenance-aware слой содержит 98 063 канонические продуктовые строки
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 115 источников
  и статусы допуска;
