...
Отдельный provenance-aware слой содержит 97 910 канонических продуктовых строк
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 110 источников
  и статусы допуска;
