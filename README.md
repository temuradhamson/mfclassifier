...
- демонстрация «До / После» на воспроизводимой случайной выборке реальных лотов ANIQLIK.
...
в production-базу ANIQLIK не записываются.
...
python3 tools/build_analytics_demo.py --lots /path/to/lots_all.json
```
