...
Отдельный provenance-aware слой содержит 98 047 канонических продуктовых строк
...
- `deliverables/Global_lubricants_catalog_registry.xlsx` — реестр 114 источников
  и статусы допуска;
