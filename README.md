...
- 282 исторические позиции из каталога АЗМОЛ;
...
- `references` — стандарты, ASTM, отрасли, температуры и АЗМОЛ;
...
АЗМОЛ передайте PDF через `--azmol-pdf`; сгенерированные данные уже включены в
репозиторий.
